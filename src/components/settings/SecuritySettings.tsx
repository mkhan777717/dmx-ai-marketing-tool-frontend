const securityActions = [
  ...
  },
  {
    ...
    description: "Revoke all active sessions immediately",
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-400 mt-0.5">Manage your password and active sessions</p>
      </div>

      {/* Action list — divide-y pattern matching profile/SecuritySettings */}
