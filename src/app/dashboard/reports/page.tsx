  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Download and review your campaign reports.</p>
      </div>
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm px-6 py-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-sm font-semibold text-slate-700">Reports coming soon</p>
